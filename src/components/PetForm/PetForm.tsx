        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="flex-shrink-0 md:self-stretch">
            ...
            <div className="flex flex-col items-center gap-4 h-full md:justify-start">
              ...
              >
                {photoPreview ? (
                  <div className="relative h-full group/photo">
                    <img
                      src={photoPreview}
                      alt="Foto do pet"
                      className="w-48 h-full min-h-[280px] object-contain rounded-lg border-2 border-gray-300 dark:border-gray-600 group-hover/photo:border-blue-500 transition-colors bg-gray-100 dark:bg-gray-800"
                      onError={() => {
