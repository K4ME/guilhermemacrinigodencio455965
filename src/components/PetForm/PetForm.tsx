        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="flex-shrink-0">
            ...
            <div className="flex flex-col items-center gap-4">
              <label
                htmlFor="foto"
                className="relative cursor-pointer group disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
              >
                {photoPreview ? (
                  <div className="relative w-40 h-40 group/photo">
                    <img
                      src={photoPreview}
                      alt="Foto do pet"
                      className="w-40 h-40 object-cover rounded-full border-2 border-gray-300 dark:border-gray-600 group-hover/photo:border-blue-500 transition-colors bg-gray-100 dark:bg-gray-800"
                      onError={() => {
                  ...
                  <div className="w-40 h-40 bg-gray-200 dark:bg-gray-700 rounded-full border-2 border-dashed border-gray-300 dark:border-gray-600 group-hover:border-blue-500 transition-colors flex items-center justify-center">
